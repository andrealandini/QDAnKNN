...
ixic.train.Direction <- ixic$Direction[ixic$Year<2021]
...
output('QDA Model for Direction~Lag1 + Lag2 on Nasdaq',
       ...
       'Confusion Matrix',
       cm.ixic,
       'The confusion matrix suggests that on days when it predicts an increase in the market, it has a',
       train.ixic,'%','accuracy rate.',
       test.ixic,'%','of daily movements have been correctly predicted.')
output('KNN Model for Direction~Lag1 + Lag2 on Nasdaq',
       '#using data before 2021 for training, 2021 data for testing',
       'Confusion Matrix',
       cm.knn.ixic,
       'The confusion matrix suggests that on days when it predicts an increase in the market, it has a',
       train.knn.ixic,'%','accuracy rate.',
       test.knn.ixic,'%','of daily movements have been correctly predicted.')
output('QDA Model for Direction~Lag1 + Lag2 on Long Short Portfolio',
       '#using data before 2021 for training, 2021 data for testing',
       'Confusion Matrix',
       cm.qda.df,
       'The confusion matrix suggests that on days when it predicts an increase in the market, it has a',
       train.qda.df,'%','accuracy rate.',
       test.qda.df,'%','of daily movements have been correctly predicted.')
output('KNN Model for Direction~Lag1 + Lag2 on Long Short Portfolio',
       '#using data before 2021 for training, 2021 data for testing',
       'Confusion Matrix',
       cm.knn.df,
       'The confusion matrix suggests that on days when it predicts an increase in the market, it has a',
       train.knn.df,'%','accuracy rate.',
       test.knn.df,'%','of daily movements have been correctly predicted.')